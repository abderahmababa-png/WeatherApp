...
{moisture_influence} وبالتالي تبقى فرص الهطول الفعلي منعدمة عند **0.0 ملم** مع تراجع احتمالية الأمطار لـ **{prob}%**، مع نشاط معتدل للرياح السطحية قد يثير بعض الأتربة العالقة في المناطق المكشوفة."""
                ...
                if precip > 2:
                    ...
                    st.info("💨 **تنبيه الغبار والجهاز التنفسي:** نشاط الرياح قد يثير الغبار والأتربة العالقة؛ ينصح بشدة بارتداء الكمامات عند الخروج، ويفضل بقاء مرضى الحساسية الصدرية والربو والأطفال داخل المنازل.")
                elif max_t > 38:
